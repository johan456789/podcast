...
S: **Se lo preparo. **
  ...
  , because we can’t have . So, we’ve seen these uses
T: **Se lo preparo**. Good, this **les** turns into **se****les lo**
  ...
  well, only it’s much more common and it’s not restricted to just a few verbs. Adding
  **se** and then
  **me**/**te**/**nos**/**le**/**les**. So, for example, *the door *was **la puerta**, **la puerta**, and *to close *was **cerrar**,

  , so let’s make that
  **cerrar**, so, if you want to say *the door closes* you will say *the door closes itself*
  first, how would you say that? *The door closes itself*:

S: **La puerta se cierra.**

  – it’s flexible. Now, if you want to say
T: Good. **La puerta se cierra **or **se cierra la puerta ***the door *
...
T: **La cena se me quema, se me quema la cena**. So, you don’t have to worry about using this
  ...
  , and you know it’s extra,
  cause any confusion when you hear it. When you have this extra **se**
  because it’s coming with , it shouldn’t cause any confusion if you hear
  **me**/**te**/**nos**/**le****se me**, **se nos**,
...
T: Good. **La batería se acaba**. If you want to say *oh, my battery always runs out*, you are talking
  ...
  we said we don’t use
  *my* as much in Spanish as we do in English, *the battery always runs out on *
  *me*, *the battery always runs out on me*, what was the word for *always*?

S: **Siempre**.

T: Good, so let’s try this sentence.
...
S: ¿**La batería se le acaba**?
  ...
  , because it’s
T: Good. ¿**La batería se le acaba**? We use **le***on you*, *the battery runs out on you*, so,
  – all included there in
  not using **lo**, using **le** – *to you, on you, from you, for you ***le**. And if you are
