...
T: In English we have many ways to talk about the past. If you get any random verb like *to eat*, for
  ...
  *I have eaten*, with **haber**. And then the other two pasts we can think of as a line in the past and a
  ...
  , all of that is ongoing. It’s like a line in the past. But then the dot
  *all the time when I was younger*
  , that’s your dot in the past. Those are what we will consider our
  in the past is *I ate*, finished. *I ate*
...
T: **Haber**. Good. So we have **haber**, and we had a neat trick to find the different versions of **haber**,
  as we know it’s very irregular. So what is
  *I have*?
...
T: So that’s our panorama of
  **haber**. And then we need to find *eaten*. So, the version after **haber**, we
  ...
  *–er/-ir*
  put -*ado*, and for verbs we take off the -*er* or -*ir* and we put -*ido*. So *I have eaten*:

S: **He comerido**. Sorry, **comido**.

T: Good. You’re taking off your ending and putting -. The only times we’re adding onto the “to”
  *ido*
...
S: **Han bailado**.
  ...
  , doesn’t change for
T: **Han bailado**. The version that comes after **haber**: **comido**, **bailado***I* or for
...
T: **Poder**. Good. So *I have been able*, the version that comes after **haber**. Rather than translating *been *
  ...
  *able*, we just want **poder** after **haber***I have been able*:
...
T: Good. **He podido comer**. *I have been able to eat.*:
...
T: So you’ve taken the sentence as a block to translate it all together, and then you have this kind of
  *ía’s*
  salad situation where this - coming out in the wrong place. You must take the time to divide it
  , what’s that?
  up. *I would have* is your first bit, and you stop there. *I would have*

S: **Habería**. **Habría**.

  . Good, and it’s a very natural irregularity. You can imagine many years of saying
T: **Habría****habería**,
...
S: **Habría podido salir**.
  ...
  *I wouldn’t have been able to go out.**I wouldn’t have been able to go *
T: Good. **Habría podido salir**.
  *out*:
...
T: Good. **No habría podido salir**. Good. So we have this **haber** that we can use for the past, but then
  ...
  , etc. So now we’re going to focus on another past in Spanish. We’re going to focus now on
  *able*
...
S: **Esperaba**.
  ...
  , speaking informally? And we don’t need the
T: Good. *I was waiting for you**for*, no? *I was awaiting *
  *you*:
...
T: Good. **Intentaban encontrarlo para mí**. So here we are emphasizing, actually *me*. But mostly in
  Spanish we kind of avoid the use of the preposition, as we’ve been noticing.
  **Intentaban **
  **encontrármelo**.
