...
T: There are also some variations that you might come across in dialect. For example, in most of
  ...
  *they*. So instead of **lo** and **la** and **los** and **las**, they are using **le** and **les**, not just to make *to him, to *
  , they will use it always when they’re referring to people and not things. So in most of Spain,
  *her*
  **le veo **means *I see him *or *her *or *you* (formal). And **lo veo **means *I see it*. But in the great majority
  ...
  . And because the accent’s coming on the end, that
  **podés***o* isn’t splitting. **Podés**. Instead of
  **quieres**, **querés**.
  ...
  **para perfeccionar nuestro español**. My advice now for the end of the course is to spend some
  ...
  project, what we’re doing, and why, then check out our website
  www.languagetransfer.org. We
