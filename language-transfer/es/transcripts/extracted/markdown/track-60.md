...
T: Good. **Cuando hablamos, comprendo todo**. So, **cuando hablamos**, that bit could be *when we *
  ...
  **comprendo todo**. But, if you wanted to say *when we spoke I understood everything*, then, of
  ...
  to give you that context. So, let’s practice that one -
...
T: **Esperar**. If you forget this one you can think of *desperate,* which means “un-hoped”. **Desesperado**
  ...
  problemo”, this is loosely based on Spanish, but of course,
  *problem* in Spanish is **problema,** not
  “problemo”, and actually you would say , not “no problema”. So,
  **ningun problema****esperar**, *to *
...
T: **Vivimos**. So, what this means is that because of this one difference we have in the entire language
  ...
  *–er *
  is that when we go into the past, *-ir *verbs stay the same, **vivimos**-**vivimos,** but verbs are
...
S: **Nos perdimos**.
  ...
  *we always get lost, but we didn’t get lost *
T: **Nos perdimos**. Good. Okay, so how would you say
...
T: **Siempre**. So, how would you say *we always get lost*?
  ...
  **Siempre perdemos… Siempre nos perdemos**
S: .
...
T: :
  ...
  **No perdimos… No nos perdimos ayer**
S: .
...
T: Good. **Nos perdemos siempre, pero no nos perdimos ayer**. Very good. There we see in that
  ...
  *we don’t go out often, but we went out *
  the same version for both. So, we could say, for example,
  ...
  *we don’t go out often*
  the sense of *small*. But **a menudo **is used very often to mean *often.* So, :
...
T: Good, very good. So, here we have the present and the past in this sentence and we see that both
  . Let’s make a recap. So, let’s do
  of them are **salimos.****No salimos a menudo, pero salimos ayer**
