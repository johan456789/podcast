...
T: **Empieza. **So this is the process we want to take. It's essential for us to get into that habit of go ing
  back to the “to" form and then we know where we are. Otherwise it's guesswork.
  **Empieza: **
...
T: **¿Cuándo empiezas? **Very good. So the *e* can split to *ie*; that's something we need to know about
  ...
  *e* vulnerable to splitting. The *e* might split to *ie*, or the *o* might split to *ue*. We know this already
  , or “to can”, of course there is no
  actually because we have **puedo**, and this is a split *o*. *To be able*
  “to can" in English,
  *to be able *we say is **poder**. Here actually you can see closer that connection
  ...
  **El poder **is *the power*. So here it's a noun. It looks like a verb, but if it has *the* in front of it, we
  ...
  means “the rich
  example, we have the word *port* in English, but we say **Puerto Rico**. **Puerto Rico **
...
T: **Cuerpo. **Good. We have *innovative*, and this *nov* in *innovative* means *new*. When you do
  ...
  *Population* in Spanish is one of these exceptions. It's not **populación**, it's **población**. And you can
  ...
  , by the way, actually means “death
  can see the *o* in *pob-* splitting into *ue* in **pueblo**. *Mortgage*
