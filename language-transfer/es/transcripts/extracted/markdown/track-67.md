...
S: /*kheneral*/.
  ...
  /. And it’s spelled the same. So, there we understand that
T: /*kheneral**g-e* makes /*khe*/ sound without
  having to learn it formally, we can just look back to these convertible words when we are unsure
  together and you are like “is that /
  of how a sound might be pronounced. So, maybe you see *c-e **se*/
  /?” But then if you look back to
  or is that /*ke***concentración**, then you have your answer: “con-
  ...
  ’s and ’s have been singled out for that role,
  syllable. Now, why do you think vowels and then *n**s*
...
T: Exactly. So, it’s what our verbs end in: an *n*, *s,* or vowel. So, Spanish says if a word ends in *n*, *s,*
  ...
  **Diferente**, **habla**, **hablan**, **hablas**, **hablamos**, ending *s*, but we are adding two syllables, so still
  ...
  of the word, and we see this perfectly with any “to” verb. How do you say
  *to eat*?
...
S: Yes.
  ...
  , right, but it’s not, it’s , it’s breaking that rule, so it has a
T: Yes, cause it should be **LI-mon****li-MÓN**
...
T: **Si.** It’s the same word, so *yes* is written with a written accent, and *if* is not. Now this written accent
  ...
  the ambiguity that could sometimes be caused by “oh, is that a ?”, both could make
  *yes* or an *if*
  sense there, especially because you use *yes* emphatically, in Spanish you can say **sí lo quiero**, *yes *
  , but if that’s written and you don’t hear the emphasis,
  *I want it***sí lo quiero**,then you might read
...
T: **Mi casa**. So, this is different **mi**: one is the **mí** that comes after prepositions – **para mí**, **por mí**, **de **
  – and the other one is for possession –
  **mí ***my*. So, **para mí**: there you have the written accent on
  , and you don’t have it on
  the **mí** of **para mí****mi casa**, just to show the difference. What was the
...
T: **Tu casa**. The word for *you*, **tú**, takes a written accent, but the word for *your* in *your house*, **tu casa**,
  doesn’t. So, monosyllables that are the same are differentiated by accent.
  *I know*, how do you say
  *I know*?

S: **Sé**.

T: Yes, this **sé** has a written accent; the **se** of **se lo doy**, *I give it to him*, the **se** of **se queda**, *he remains *
  , doesn’t have an accent; only the , has one. So, it’s
  *himself/she remains herself***sé** of **saber**, *I know*
...
T: *Where*. But sometimes **donde** is a question word, like ¿**dónde estás?***Where are you?* There it will
  *I’m going to meet him where we saw the football*
  go with an accent, but if I say , this is not a
  ...
  *like,* the **cómo** for *how* takes an accent and the **como** for *like* doesn’t. So, there are a couple of
  ...
  ’s or ’s, and in the
  only need to look at the present tense. We know that our verbs end in vowels, *n**s*
