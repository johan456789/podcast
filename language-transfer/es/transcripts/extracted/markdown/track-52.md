...
T: **Para**, this *for*, **para**, can also mean *in order to,**in order to*. So in a sentence, for example, *We have *
  *spoken in order to resolve it*. *We have spoken in order to resolve it. *Now in English we could just
  , no? We don’t need to say
  say *We have spoken to resolve it**in order to*. But whenever we have this
...
T: Good. **Hemos hablado para resolverlo**. Good. So whilst the *to* of *to resolve*, **resolver**, would fit
  ...
  doesn’t work in Spanish. Whenever this
  *to* means *in order to,* we must put that **para**. **Hemos **
...
T: Good. **Hemos hablado para intentar resolverlo**. So only when the *to* implies *in order to* we want
  . The “*to”*
  to put **para** form of the verb in Spanish is not enough to include that meaning. We must
  *I’m here to see you**I’m here in order *
  put **para**. So for example, if you want to say , does it mean
  *to see you*?
...
S: **Comiendo**.
  ...
  *–er/-ir *
T: Good. **Comiendo**. So we add on -*iendo* for verbs and for –*ar* verbs we add on?
...
T: **Estoy hablando**. *I am explaining it*: *to explain* – we would go from *explanation* but *explanation*
  is an exception. It’s not “explanación” in Spanish as we might hope, it’s
  **explicación**. And we see
...
S: **Explicar**.
  ...
  *I’m explaining it*
T: **Explicar**. Good. So and you mean right now?
...
T: **Estoy explicándolo. Lo estoy explicando.** The **lo** can go on the end of a “to” form, but it can also
  ...
  *I’m taking a Spanish course*. Even if you’re not in the
  *explain*, *to unfold*. You might want to say
  course right now in this moment, when we are taking a course, in our minds there’s a period of
  *I’m *
  time in which we are taking a course and when we say it we’re in that period of time. If I say
  , maybe I mean for three months and I’m in that period. Do you remember
...
T: Good. **Estoy tomando**. *A course*

S: **Una corsa? **

T: Close. It’s not with , it’s with
  *a**o*.
...
T: So you have this option. **Comía** or **estaba comiendo**
  sometimes one might fit slightly better than the other and it’s something you will pick up very
  naturally when you’re practicing. So if in one situation people tend to use
  **estaba comiendo **rather
  than **comía**, you will pick it up. So we have -*ando* and -*iendo* to form this -*ing*. And we saw in
  Spanish that we don’t use it after prepositions. You don’t use this -
  *ing* either if you say something
  . You don’t use the -
  like *swimming is healthy* or *running is healthy**ing* there either. You will just
...
T: **Nadar es saludable**. So we’re seeing that we don’t use the -*ing* in Spanish as much as we do in
  ...
  *interesting*. When we do this in English, this -*ing* that we use in English to form an adjective, in
  Spanish it’s -*–er/-ir *
  *ante* for –*ar* verbs and -*iente* for verbs. So for example, we have *to interest*,
...
T: When the moon gets smaller, it’s waning. And
  *the moon* is **la luna**.
...
T: Good. So there we’re making *waning* like an adjective, not like the verb, not **menguando**. Ah?
  **Menguante, la luna menguante**. **Luna** is an interesting word. I don’t know if you ever noticed,
  ...
  relate back to the planets. But in Spanish it’s very obvious. You have
  **la luna**, *the moon*, and then
...
T: Good. We have two “to be”s, we have
  **estar** for states, and for characteristics we have?
...
T: You could say **un ser vivo**. **Vivo** is also like an adjective, which means *alive*. But *living* is adjective
  *–er/-ir *
  that we make with -*ing*. We can build it from **vivir**. For –*ar* verbs we have -*ante* and for
  verbs we have -*iente*.
...
S: **Voy**?
  ...
  . So it’s “”. I don’t care if it’s wrong, but I want it to end in
T: *To go out* or *to leave**to**r*.
