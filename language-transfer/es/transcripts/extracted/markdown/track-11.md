...
T: So we saw how our “to" form of the verb:
  *to come, to eat, to tolerate*. How would *to tolerate* be?

S: *Toleration*-**toleración**-**tolerar.**

  . Good. So our “to” form ends with an
T: Exactly, **tolerar***r* and it's always going to be *-ar*, *-er* or *-ir*.
...
T: **Como.** Good. This also means *how* or *like*, by coincidence. You might have heard **cómo estás? - **
  *How are you?* But **como** is also *I eat*. So for all verbs, we take off the ending and we add *-o* and
  we get the “I” version. But for the rest of the versions, for
  *he*, *she*, *it*, *you (*formal), for *we, *etc., the
...
T: Good. And we still have the accent on the penultimate syllable, **elimina**. Very good. How do you
  ...
  say that: “a period of time”, sometimes we call it
  *duration*, no?
...
S: **Durar mucho.**
  ...
  be? So…
T: This is *to last*, **durar**. So how would *it lasts**** ***
