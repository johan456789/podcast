...
T: It is a bit of a long word, but if you break it up it’s easier to digest. You have
  **de****más**, *of**more*, -*iado*.
  ...
  **coches**. And you might hear **demasiado agresivo**, **demasiado agresiva**,and **demasiado **
  . Here it’s changing
  **agresivos**. Again. You might hear **demasiadas casas**, **demasiados coches**
  And then here it’s not.
  from the base form **demasiado**. **Demasiadas casas. Demasiados coches. **
...
S: Adjectives.
  ...
  . Well done. Brilliant. That’s it. We said that identifying what type of word we have
T: **Espectacular**
  ...
  **coches**. But when it goes with an adjective it won’t: **demasiado agresivo**, **demasiado agresiva**,
  . It’s not changing. So we didn’t learn that here, but
  **demasiado agresivos**,** demasiado agresivas**
  we have been analytical enough of the language for you to figure that out by yourself. So another
  example for you to figure out what’s going on. Now the words
  **ala**, *wing*, **agua**, *water* and **aula**,
  *hole* or *classroom* are all feminine words, but we say **el ala**, *the wing*. **El agua**, *the water*. And **el **
  . What’s going on?
  **aula**, *the classroom*

  , and it would be weird to say “la ala”.
S: Is it because the first letter of those words is *a*

T: You have other words that begin with *a* where you have *la* at the beginning, for example **la **
  . So you need to find something that’s different
  **alfombra**, *the carpet*. **La almohada**, *the pillow*
...
T: That’s it. There are two syllables and they begin and end in . So it’s a very specific thing. It’s not
  *a*
  ...
  *do you want*, you will reply to me **uno****ninguno**. But if I say *one man*,
...
T: Yes, because we have a noun following it and it loses that last *o*. So **uno**, **alguno**, **ninguno**, become
  . And you would notice that it doesn’t happen with the feminine. So we have
  **un**, **algun**, **ningun**
