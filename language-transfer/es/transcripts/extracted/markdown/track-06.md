...
S: **Intento publicarlo.**
  ...
  . We’ve got both there.
T: Good. **Intento publicarlo.***I try to publish it *or *I am trying to publish it*
...
T: Good. **Intento administrarlo.***I am trying to imitate it* or *I am trying to imitate him*. It could mean
  ...
  OK, it’s
S: **Intento, ***imitation-***imitación-imitar**. **Intento imitarlo**.

T: Exactly. Now *h's* in Spanish are completely silent. You must be careful not even to *think* them
  because they will have a habit of slipping out even if you think it. So it’s written, the
  *h* is written
  *–al*) but it’s not pronounced. You must
  in convertible words for example, like *hospital* (ends in
...
S: **Horrible.**
  ...
  . If you can’t
T: Good. And here we have an example of double *r* inside the word. **Horrible**, **horrible**
...
T: Yeah. Unless it’s
  *c-h* in which case it’s like English /ch/. **Ahora** is actually the combination of two
  . So it’s something like “to the hour”. So that
  words: **a** which means *to* and **hora** which means *hour*
...
T: Good. Now this is actually spelled *v-o-y*. Now the *v* in Spanish can sound like a *v* in English like a
  ...
  *let’s go*
  , literally *we are going*, used a lot like *let’s go*, **vamos**. Now this is spelled *v-a-m-o-s*. What
...
T: Exactly! Very good! This is it. It’s a word that exists that we only use in some context, like
  ...
  speaking to so it’s not a fundamental issue of ours right now. So,
  **visitar**. *I want to visit him:*
...
T: Good. There is something very good that you are doing here, you are not pronouncing that *s* as a *z*
  ...
  from English and pronouncing **vi-zi-ble****visible**. And the *v* is like a
