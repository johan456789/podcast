...
S: **Hay**.
  ...
  . And for once we have a situation where it’s changing in English and it’s not changing in
T: **Hay**
  , it’s not changing. The word for
  Spanish: **hay** means *there is *or *there are**somebody* is **alguien**,
  **alguien**.
...
T: Very good. **Hay dos personas aquí que hablan español**. Very good. The past of **hay** is **había**,
  ...
  , no? It’s always , doesn’t change.
  *there was***había****Hay** doesn’t change for *there is *or *there are*,
...
T: So, you believe that’s the negative language transfer, that’s great! So, it makes sense for it to be
  ...
  don’t want to take a direct translation from English, from
  *spoke*, we want to just look at the context
...
T: Good. **Había dos personas aquí que hablaban español**. If we were to use the point here – **que **
  – we wouldn’t be talking about the fact that they are Spanish-speakers, but
  **hablaron español **
  ...
  *something*, this *be* is actually coming from *there is/there are*, not from *to be*. It’s coming from this
  ...
  , in which case it’s
  *something that you can do*, this *be *is *exist*, *there must exist something***haber**.
  It’s not
  **ser** and it’s not **estar**, and if you try to think which one it is, **ser** or **estar**, you will be a
  ...
  *be something that you can do* (let’s speak informally). *There has to be something that you can do*.
  ...
  You can use *has**to* or *must*

S: **Tiene que hay**-

T: But it’s
  *to* form, so **hay** and **había** come from?
...
T: Yes, **puedas**, very good. **Tiene que haber algo que puedas hacer**. Because here, like before with
  ...
  something when we don’t know whether it exists or not, with this structure of
  **hay** and **que**. So,
