...
T: You only use it if you want to be emphatic. So if you want to say “***I****want*
  how would you do it?
...
S: **No yo quiero.**
  ...
  *I don’t want:*
T: The same order as English.

S: **Yo no quiero.**

  *I don’t want**I don’t want to cancel:*
T: Good, **yo no quiero**. . Good,
...
T: And this is informal *you*, this is used informally. How would you say then
  ? You might think “I don’t know this!” It’s very important, sentences that we think we don’t
  *you*
...
T: **Obligar.** So we don’t want to jump from *oblige* to sticking -*ar* on it. We want to take that long
  *I don’t want*
  route. *Obligation*, **obligación**, **obligar**. And then we find the word in Spanish. So, ,
  **no quiero**, *to oblige you:*

S: **No quiero obligarte.**

  *I don’t want to oblige you. I don’t want to make you do it.*
T: Good, **no quiero obligarte**. So in

  English we would say *make you*, maybe. Maybe *oblige* sounds a little bit too formal, but in Spanish
  *I don’t want to provoke you**I don’t want to provoke *
  it's everyday language. How would you say ?
  *you:*
...
T: Good. I want to talk about this *r*. An initial *r*, like in **regular** in most Spanish dialects, it's a rolling
  *r*. You get this flick of the tongue, **regular**. **Real, **we saw this as well in *real***, real.** Now, if you
  ...
  you hear, just because you want to pronounce it it’s going to come. So initial
  *r* or two *r'*s together
...
T: So that’s the difference. You have normal
  *r*: **pero**.
...
T: **Participar.** So we must take it slowly, sometimes you don’t need to take it slowly, but we want to
  ...
  process slowly. We don’t want to jump from
  *participate* to **participar** because maybe we end up
  putting some extra sound “” or something like this and we don’t want to do this. We
  **participatar**
...
T: Yeah, that’s it.
  **Experimentar.** And this also means *to**experience*.* To experiment *and* to *
  ...
  *–ence*
  nice rule: *experience*, **experiencia**. If we have a word that ends in or –*ance*, we can change
  –**–encia****–ancia,**
  *ence* to and –*ance* to and we will get the word in Spanish. *Difference*?
