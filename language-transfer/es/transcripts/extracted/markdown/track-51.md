...
T: **Estoy**. If you want to say , , you know, in this supportive way,
  you don’t have to say
  *there* to begin with. Because we are using **estar** and not **ser**, it kind of makes
  that *there* a little redundant. We feel that already in **estar** that’s referring to states, locations and
  states, so we don’t need to say *I’m for you, I’m for you,*
  *there*. We can just say using **estar**. What
  *for* do you think you need?

S: **Para**.

  *I’m there for you,*
T: Good. So how would you say talking to a friend?

S: **Estoy para ti. **

  *I’m here because of you*. We don’t
T: **Estoy para ti**. Good. To say , then we are not going to use **para**
  even really need to say *here*.

S: If it’s still
  **estoy** it still implies location.
...
S: ¿**Cambiarías estas por esas? **
  ...
  *Wouldn’t you change these ones for those ones?,*
T: Good. ¿**Cambiarías estas por esas**? still
  feminine:
...
T: Good. We don’t want to stop thinking. You will be able to relax that as you go on, but at the
  ...
  you’re chatting online, if you’re practicing your Spanish online you might see
  **por** written as an *x*
  ...
  *for*. **Para,** something being *for you*, quite literally, and then **por**, which is much more flexible in
  ...
  prepositions, so these little group of words, we’ve seen - , we’ve seen
  **para**, **por**, **de**, **en**, **con**, **a**
  quite a few of them - following these words in English we put -*ing*. *Thank you for coming.* But in
  Spanish we just put the “to” form.
  **Gracias por venir. **So how would you say *thank you for calling*,
  *what’s your name?*
  *thank you for calling* - if you forget *call* you can think of or *how are you called?*
...
S: **Gracias por llamarme. **
  ...
  . So after prepositions we don’t use the -
T: Good. **Gracias por llamarme***ing*. We want to resist any
...
S: **Cansada**.
  ...
  *I’m tired of*
T: Good. **Estoy cansada**. So if you want to say – *dancing*, *cooking*, *cleaning* – it’s all
  going to be with the “to” form. What was
  *to work*?

S: **Trabajar**.

  *I’m tired of working*
T: **Trabajar**. How would you say ?
...
T: Yes. **Estoy cansada de trabajar.** Good. For one of the pasts that we saw, for the line in the past,
  so when we’re referring to like a period of time in the past, for *–ar*
   verbs we have the -*aba* base
...
T: **Estaba cansada de trabajar**. Good. *I was tired of working.* Good. *We were tired of working*, and
  let’s be a masculine or a mixed group.
  *We were tired of working*:

S: **Estábamos cansados de trabajar. **

  *it’s a way *
T: Very good. **Estábamos cansados de trabajar.** Good. If you want to say something like
  *it’s a way of doing it,*
  *of doing it*, the word for *way* is *form*, *a form of doing it*, and how do you
...
S: **Es una forma de hacerlo. **
  ...
  *I don’t believe in arguing like this**I don’t *
T: Good. **Es una forma de hacerlo**. Good. , *in this way*.
...
T: Yes. So we get this situation occasionally in Spanish that the “” form of two different verbs will
  *I*
...
T: *In arguing*. So *to argue* in Spanish you can use *to discuss*. This is the most common verb, actually,
  that’s used for
  *argue*. *Discuss* is **discutir**, **discutir**.
...
T: **Hablar**, mostly, but you can use **discutir** as well for *discuss*, but it has a heavy connotation mostly.
  ...
  **Argüir**, which is *argue*, means to argue a point, rather than to get in an argument. **Discutir** is more
  ...
  , which doesn’t mean
  for them between English and Spanish. Another example would be **actual**
  ...
  *at the moment*, rather than *actually*. Mostly the vocabulary, the Latin English that we turn into
  ...
  of them. This doesn’t really mean
  *to discuss* as much as it does *to argue*. So, *I don’t believe in *
  *arguing*:
...
T: Good. So all together, , *in discussing*, *in this way*:
...
T: Good. **No creo en discutir de esta forma**. Good. So with this sentence, **gracias por venir**, we are
  ...
  don’t need to worry about making the -
  *ing* form of the verb, we just use the “to” form.
