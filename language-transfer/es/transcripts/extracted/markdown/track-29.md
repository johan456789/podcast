...
T: And the other irregularity that we have is that this verb is the only verb in the entire Spanish
  ...
  “éstoy” it's
  **estoy**; the accent is on the ending. This hasn't happened until now, and it won't happen
...
T: Good. And for the “*we”*
   version, the accent is where it should be because we're adding two
  syllables. So give me the “” version.
  *we*
...
T: Good. **Estoy cansada siempre**. **Estoy siempre cansada**. **Siempre estoy cansada**. Or I would say
  . Good. So we want to resist the temptation to simplify this concept to “temporary” and
  **cansado**
