...
T: Good. **He cancelado**. And we said that the version of the verb that you get after **haber** – you can
  ...
  *it’s cancelled*
  could say . We use the same version, *cancelled,* that comes after **haber**. So we can
...
S: **Complicación**, **complicar**.
  ...
  , “with folding”,
T: **Complicar****complicar**. Good. If you want to say *it has got complicated,**it has got *
...
T: **Está complicado**. Actually, with this one you can use either; there tends to be a tendency to go
  ...
  **complicado**, **está complicado**, depending on what you were talking about, you might feel more
  ...
  . Let’s start with
  can also make structures like *should have*, *could have* with this **haber***should have*.
  , and it’s related to
  Now *should*, we take it from the verb *to owe*, which also we use like *must*
  English *debt*.
...
S: It’s after the unchanged verb, so
...
S: **Podríamos haber ido. **
  ...
  , whether it’s the “to”
T: Good. **Podríamos haber ido**. Good. So, after **haber**, any version of **haber**
  , whether it’s
  form, **haber****habría**, any version of **haber**, it’s going to have –*ado* or –*ido* with the
  following verb. But some verbs are irregular and they don’t form their version after
  **haber** in this
  way. So, *to break*, related to *rupture* in English, was **romper**. Now, this after **haber** is not
  “rompido”, “rompido” doesn’t exist, it’s irregular, after
  **haber** it’s **roto**: *r-o-t-o, ***roto**. So, how
...
S: **Morir**.
  ...
  is not “morido”, it’s
T: And the version after **haber ****muerto**,** muerto**. How would you say *he has *
  *died*?
...
T: Yes, but it doesn’t, it never goes with
  **ser**. So, some of these adjectives we form in this way can go
  , but this one can’t. So, firstly, how would that be,
  with **ser***he is dead*?

S: **Está muerto. **

T: **Está muerto**. So, *complicated*, for example, could go with **ser** and **estar**, but **muerto** can’t. Maybe
  it’s not just because they are this type of adjective, that
  *dead* will go with **estar**, maybe it is about
  the way Spanish perceives the world. To be dead is a state, that the soul goes through, let’s say,

  you don’t know what is the perception behind that, or, if it’s just going with
  **estar** because it’s one
  ...
  *I’m dead*
  How would you say (and you can use this to mean *tired)*? This is quite common in
  *oh, I’m dead.*
  Spanish, if you are really tired, you can say
...
T: Yes, feminine. **Estoy muerta**. Good. You can say also *I die myself* here, like **morirse**, in all
  ...
  build it, let’s see how it would sound. So,
  *to die*, **morir**, *I die myself*, making this reflexive
  structure, how would it sound?

S: It’s irregular so the “mue” is going to come in.
  **Muero**, maybe? **Muero**?
...
S: **Abrir**.
  ...
  . So we don’t have “abrido”
T: **Abrir**. And if you want to say *I have opened it,* you say **lo he abierto**
...
T: Good. **Le hemos dicho**. Good. Interestingly, **dicho** is also a noun. We said that some version of
  ...
  it’s the “he, she, it” form. Here it’s this form.
  **Un dicho** is *a saying, a saying*. **Hacer** after **haber**
...
T: Good. **Está hecho**. You might also see this used like **hecho en China**, *made in China*, or **hecho **
  **en España**, *made in Spain*, you will see this on products, should be a nice reminder. So, **hecho** as
  ...
  , and it’s actually connected to the word
  **un hecho** is *a fact**fact*, even though they look so different.
  ’s and ’s, because
  There is in Spanish and English what we can call a kind of grey area between *h**f*
  ’s became silent ’s, just as
  in a phonetic change that occurred in Spanish many *f**h***hecho** is from
  , so “faire”, like in French, if you know some French, is
  **hacer**, *fact* is from *to do**to do*, and fact is
  related to “faire”, just as
  **hecho** is related to **hacer**. And we can find some other connections
  ...
  *fraternal.***Hembra**, which means *female*, *h-e-m-b-r*-a. Even within Spanish you can see this
  ’s and the ’s. For example you have
  phenomenon of the *h**f**iron* which is **hierro**, *h-i-e-r-r-o*, **hierro**,
  ...
  *h-u-m-o,* is *smoke*, like a noun, **el humo**, *the smoke*. So there are some interesting things we can
  ’s and ’s. Also you can
  find between English and Spanish and within Spanish itself with these *f**h*
  look out for some connections with other letters, you will find other pairs of letters like this, for

  ’s and ’s – you get
  example *w**g**war* in English and **guerra** in Spanish, *William* in English and
