...
T: **Eliges**. Good. So how would you say Now when *for* means *on *
  *my behalf, I don’t want you to choose for me, I don’t want you to choose on my behalf*
  , the *for* that
  . But, maybe we don’t mean
  we use is **por***on my behalf*. Maybe we mean *I don’t want you to *
  *choose something for me*. Literally *something that is for me*. So, in that case we would use **para**.
  But, let’s make the sentence like *I don’t want you to choose for me. I don’t want you *
  *on my behalf*.
...
S: **No quiero que elijas por mí**.
  ...
  *I don’t want you *
T: Very good. **No quiero que elijas por mí**. Good. So **por mí **is like on my behalf.
  *to take my decisions.***No quiero que elijas por mí**. *To break* was **romper**, or **romperse** if we say
  ...
  English, which also means it’s related to
  *corrupt*. The -*rupt* of *corrupt* is *rupture*, *disrupt*, *erupt*.

  *I don’t want it to break? I don’t want it to break*
  So **romper** is *to break*. How would you say :
...
S: **Se rompa**.
  ...
  *I don’t want him or her to break *
T: Good. If you were to say **no quiero que lo rompa**, it would mean
  *it*, or *you* (formal) to break it. If you say **no quiero que se rompa**, we are not saying *who*. We are
  *I don’t want it to break**I don’t want it to break itself*, even though we don’t literally
  just saying .
  , when it’s
  mean *itself*. We said that we can use **para**, *for*, **para**. We can use **para** like *to**in order *
...
T: Good. **Nos hemos encontrado para hablar**. Good. So *we have met up to speak*. And, although
  we wouldn’t say
  *in order to speak* usually in English, if that *to speak *implies *in order to speak *
...
S: **Hemos cocinado para que coman**.
  ...
  . And you can’t
T: Good. **Hemos cocinado para que coman**. Good. *We have cooked so that they eat*
...
S: **Para que vuelvas.**
  ...
  *I’ve done it so that you come back. I’ve *
T: Good. **Para que vuelvas**. So you could say something like
  *done it so that you come back*. So *I have done*: the version of **hacer** after **haber**, after any version
  . It’s very irregular. And we said that
  of **haber** is **hecho****hecho**, the version of **hacer** after **haber**,
...
T: Good. **Lo han hecho para que volvamos**. *They have done it so that we come back*. And I should
  ...
  , it’s just
  So you will notice it if you hear **pa****para**. What was the word for *so*, like in *so tired*?
...
T: **Tan**. And **también,***t-a-m-b-i-e-n *is *as well*, *also*. And it actually has *tan* inside there. The *n* turned
  ...
  *well*, from *as well*, **bien**. So interestingly they are like direct translations of each other. Even though
  ...
  if you think about it the direct translation doesn’t make any sense: *as well*
